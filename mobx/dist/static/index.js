...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_mobx__ = __webpack_require__(15);
...
var _peopleStore = __webpack_require__(33);
...
var store = {
  ObservableTodoStore: _todo2.default,
  peopleStore: _peopleStore2.default
...
var _TodoView = __webpack_require__(31);
...
var TodoList = (_dec = (0, _mobxReact.inject)('ObservableTodoStore', 'peopleStore'), _dec(_class = (0, _mobxReact.observer)(_class = function (_React$Component) {
  ...
  function TodoList(props) {
    ...
    _this.onNewTodo = function () {
      _this.props.ObservableTodoStore.addTodo(prompt('Enter a new todo:', 'coffee plz'));
    };

    var _this$props = _this.props,
        ObservableTodoStore = _this$props.ObservableTodoStore,
        peopleStore = _this$props.peopleStore;
  ...
  _createClass(TodoList, [{
    ...
    value: function render() {
      ...
      var _props = this.props,
          ObservableTodoStore = _props.ObservableTodoStore,
          peopleStore = _props.peopleStore;
      // ObservableTodoStore.initialData()
      // ObservableTodoStore.addAssignee(0, peopleStore.name[0])
      // ObservableTodoStore.addAssignee(1, peopleStore.name[1])
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'ul',
          null,
          ObservableTodoStore.todos.map(function (todo, idx) {
            return _react2.default.createElement(_TodoView2.default, { todo: todo, key: idx });
          })
        ),
        ObservableTodoStore.pendingRequests > 0 ? _react2.default.createElement(
          'marquee',
          null,
          'Loading...'
        ) : null,
        ...
        _react2.default.createElement('input', { onKeyUp: function onKeyUp(e) {
            return _this2._changeName(e);
          } }),
        _react2.default.createElement(
          'button',
          { onClick: function onClick() {
              return _this2._marquee();
            } },
          '\u70B9\u6211\u554A'
        )
      );
    ...
    value: function _marquee() {
      ...
      setTimeout(function () {
        _this3.props.ObservableTodoStore.addTodo('Random Todo ' + Math.random());
        _this3.props.ObservableTodoStore.pendingRequests--;
      }, 2000);
    }
  }]);
...
var TodoView = (0, _mobxReact.observer)(_class = function (_React$Component) {
  ...
  function TodoView(props) {
    ...
    _this.onToggleCompleted = function () {
      var todo = _this.props.todo;
      todo.completed = !todo.completed;
    };

    _this.onRename = function () {
      var todo = _this.props.todo;
  ...
  _createClass(TodoView, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        'task: ' + todo.task + ' ',
        todo.assignee ? _react2.default.createElement(
          'small',
          null,
...
var ObservableTodoStore = (_class = function () {
	...
	_createClass(ObservableTodoStore, [{
		...
		key: 'addAssignee',
		value: function addAssignee(key, value) {
...
}), _applyDecoratedDescriptor(_class.prototype, 'completedTodosCount', [_mobx.computed], Object.getOwnPropertyDescriptor(_class.prototype, 'completedTodosCount'), _class.prototype), _applyDecoratedDescriptor(_class.prototype, 'report', [_mobx.computed], Object.getOwnPropertyDescriptor(_class.prototype, 'report'), _class.prototype), _applyDecoratedDescriptor(_class.prototype, 'addTodo', [_mobx.action], Object.getOwnPropertyDescriptor(_class.prototype, 'addTodo'), _class.prototype), _applyDecoratedDescriptor(_class.prototype, 'initialData', [_mobx.action], Object.getOwnPropertyDescriptor(_class.prototype, 'initialData'), _class.prototype), _applyDecoratedDescriptor(_class.prototype, 'addAssignee', [_mobx.action], Object.getOwnPropertyDescriptor(_class.prototype, 'addAssignee'), _class.prototype)), _class);
exports.default = new ObservableTodoStore();
...
var PeopleStore = (_class = function () {
...
exports.default = new PeopleStore();
